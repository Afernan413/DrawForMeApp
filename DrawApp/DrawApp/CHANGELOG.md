...
This file preserves the detailed development changelog and implementation notes that were moved out of `README.md` to keep the main README concise and user-facing.
